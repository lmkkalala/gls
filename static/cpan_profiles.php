    ...
    <ul class="nav navbar-right top-nav">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li class="current">
                        <a href="<?=site_url()?>dashboard/cpan_profiles"><i class="fa fa-users fa-edit active"></i> Profiles</a>
                    </li>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-dashboard"></i> Dashboard/profiles
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                ?>
                  <div class="col-lg-4  col-md-6 col-sm-12">
                    <div  class="pb-5 pt-5" style="margin-bottom:20px; background-color:#efefef !important; padding:20px; border-radius:10px;">
                      ...
                      <a href="#"><img src="<?= base_url('images/profiles/'.$users_item['image']); ?>" class="img-responsive img-thumbnail img rounded-circle" style="max-height: 200px; max-width: 200px; border-radius: 5px; border-color: white; border-width: 5px;" alt="img"></a>

                      <div class="journal-txt">
                        <?php if($users_item['validation'] == '0'):
                               echo '<h1><a href="#" class="text-danger ">'.$users_item['Noms'].'(compte Pas encore validé)</a></h1>
                                <span class="bagde">'.$users_item['nombre_de_post_par'].'Postes</span>';

                                else: echo '
                                <h4><a href="#" class="text-primary">'.$users_item['Noms'].'</a></h4>
                                <span class="bagde">'.$users_item['nombre_de_post_par'].'<i class="fa fa-comments "></i> Postes</span>';
                                endif;
                            ?>

                        <h6 class="text-primary text-left">
                            <?='Compte cree le : '?><?=$users_item['Date_creation']?>
                        </h6>
                         <h6 class="text-primary text-left">
                            <?='contacts: '?><?=$users_item['contacts']?>
                        </h6>
                        
                         <p>
                             <?php if($users_item['validation'] == '0'):
                                echo '<a href="'.site_url('dashboard/cpan_profiles/Supprimer/'.$users_item['user_id']).'" class="btn btn-danger btn-lg">Supprimer</a> ';
                                echo '<a href="'.site_url('dashboard/cpan_profiles/valider/'.$users_item['user_id']).'" class="btn btn-primary btn-lg">Valider</a><br>';
