...
<section id="blog">
  <header id="home" class="white-bg">
    ...
    <div class="container pt-150 pb-150" id="blog">
      <div class="row">
        <div class="heading text-center col-sm-12 wow fadeInUp " data-wow-duration="1200ms" data-wow-delay="300ms">
          <h2>Blogs publiés</h2>
          <p>Nous publions habituellement des nouvelles ici, assurez-vous que vous êtes à l'écoute pour être le premier lecteur !</p>
        </div>
      </div>
                              ...
                              <div class="col-xl-4 col-lg-4 col-md-6 d-flex">
                                <div class="blog-wrapper mb-30">
                                    <div class="blog-thumb mb-25">
                                        <a href="<?=site_url('welcome/lire/'.$str_titre_url); ?>">
                                ...
                                <hr>
                                  <div class="blog-content">
                                      ...
                                      <div class="read-more-btn"  style="position:absolute; bottom:20px;">
                                          <a class="btn btn-info" href="<?=site_url('welcome/lire/'.$str_titre_url);?>">Lire</a>
                                      </div>
                                  </div>
                            </div>
                          </div>
