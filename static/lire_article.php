                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-xl-2 col-lg-2 col-md-6 col-6">
                            <div class="logo">
                                <a href="index.html"> <img src="<?=base_url("img/logo.jpg")?>" id="logo" alt=""> </a> <span id="brand-text">ITIG</span> </div>
                        </div>
                            ...
                            <div class="main-menu f-right">
                                <nav id="mobile-menu" style="display: block; font-size: 10px;">
                                    <ul>
                                        ...
                                        <li> <a href="<?=base_url()?>#about">à props</a> </li>
 ...
 <div class="course-details-area gray-bg pt-100 pb-70">
        <div class="container">
            <div class="row">
                <div class="col-xl-8 col-lg-8">
                    <div class="blog-wrapper blog-list blog-details blue-blog mb-50">
                        ...
                        <hr>
                        <div class="blog-content news-content posts">
                            <div class="blog-meta news-meta">
                                <span><?=$news_item['post_date']?></span>
                            </div>

                            <h5><?=$news_item['post_titre']?></h5>
                            <h6>Par: <strong><?=$news_item['post_owner']?></strong> <i class="fa fa fa-certificate"></i><i class="fa fa-check-square-o" aria-hidden="true"></i></h6>
                            <hr>
                    ...
                    <div class="post-comments post-comments-padding white-bg mt-70 mb-30">
                        <div class="section-title mb-20">
                            <h2>Commentaires <i class="fa fa-comments"></i> (<?=$news_item['nombre_de_commentaire'];?>)</h2>
                        </div>
                                 ...
                                 <li>
                                        <div class="comments-box main-comments d-flex">
                                            <div class="comments-avatar">
                                                <img src="<?=base_url('images/profiles/'.$comment['comment_owner_profile'])?>" style="width: auto; height: 120px; border-radius: 30px;" alt="">
                                            </div>
                                            <div class="comments-text ml-2">
                                                <div class="avatar-name">
                                                    <h6 class="text-info"><?=$comment['comment_owner']?></h6>
                                                </div>
                                                <p><?=$comment['comment_content']?></p>
                                                <a><i class="fa fa-calendar"></i> <?=$comment['comment_date']?></a>
                                            </div>
                                        </div>
                                    </li>
                                <?php endforeach;?>
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 ">
                    <div class="section-title mb-50 text-center">
                        ...
                        <div class="section-title-para">
                            <p class="gray-color">Retrouver ici les derniers articles et magazine de l'ITIG, vous pouvez aussi deposer le votre pour analyse et validation via l'espace membres <a href="<?=base_url("login")?>" >ici</a></p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                        ...
                        ?>
                              <div class="col-xl-12 col-lg-12 col-md-12 posts">
