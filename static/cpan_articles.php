            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                     ...
                     <li class="current">
                        <a href="<?=site_url()?>dashboard/cpan_articles"><i class="fa fa-fw fa-edit active"></i> Articles</a>
                    </li>
                    <!--li>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-dashboard"></i> Dashboard/articles
                            </li>
                        </ol>
                    </div>
                </div>
            ...
            <div class="container-fluid blog-container ml-1 mr-n1">
              ...
              <div class="journal-block">
                ...
                ?>
                  <div class="col-lg-6 col-md-12 posts">
                    <div  class="mb-5 mt-5" style="margin-bottom:20px; background-color:#efefef !important; padding:20px; border-radius:10px;">

                      <a href="#"><img src="<?= base_url('images/news-pic/'.$news_item['post_illustration']); ?>" class="img-responsive img-thumbnail " alt="img"></a>

                      <div class="journal-txt">
                        <?php if($news_item['validation'] == '0'):
                               echo '<h4><a " class="text-danger ">'.$news_item['post_titre'].'(en attente de  validation)</a></h4>
                                <span class="bagde">'.$news_item['nombre_de_commentaire'].'<i class="fa fa-comments "></i> commentaires</span>';

                                else: echo '
                                <h4><a href="'.base_url()."welcome/lire/".urlencode($news_item['post_titre']).'" class="text-primary">'.$news_item['post_titre'].'</a></h4>
                                <span class="bagde">'.$news_item['nombre_de_commentaire'].'<i class="fa fa-comments "></i> commentaires</span>';
                                endif;
                            ?>
                        ...
                        <h6 class="text-primary text-left">
                         ...
                         <p class="border shadow mt-2"><?=$news_item['post_caption']?><p><?php echo'<a target="_blank" href="'.base_url()."welcome/lire/".urlencode($news_item['post_titre']).'" class="text-primary"><i class="fa fa-external-link"></i> Voir l\'aperçu</a>'?></p></p>
                         <p class="text-right">
                             <?php if($news_item['validation'] == '0'):
                                echo '<a href="'.site_url('dashboard/cpan_articles/Supprimer/'.$news_item['post_id']).'" class="btn btn-danger btn-lg">Retirer</a> ';
                                echo '<a href="'.site_url('dashboard/cpan_articles/valider/'.$news_item['post_id']).'" class="btn btn-primary btn-lg">Publier</a><br>';
